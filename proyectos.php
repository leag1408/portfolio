        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-5 col-12 mt-4">
                    <h1 class="mt-sm-4 pb-sm-4">Proyectos</h1>
                    <p class="pb-sm-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Minima, nam sunt fugit vero delectus a
                ...
                <div class="col-sm-4 col-12">
                    <div class="row card m-1">
                        ...
                        <div class="col-12 py-3">
                            <p>Alta, Baja, modificación de un registro de clientes
                                empleando:. Realizado en HTML, CSS, PHP, Bootstrap y Json.S</p>
                        </div>
